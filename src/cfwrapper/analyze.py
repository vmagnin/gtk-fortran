...
""" This module contains functions to analyze C prototypes and generate Fortran interfaces.
"""
...
def analyze_prototypes(index, module_name, f_file_name, unix_only_file, mswindows_only_file, f_file, preprocessed_list, whole_file_original, c_dir, c_file_name, gtk_enums, gtk_funptr, TYPES_DICT, TYPES2_DICT, my_stats, my_errors, ARGS):
    ...
    for proto in preprocessed_list:
        ...
        if not error_flag:
            write_fortran_interface(index, module_name, f_file_name, unix_only_file, mswindows_only_file, f_file, whole_file_original, c_dir, c_file_name, function_status, proto, f_procedure, f_name, args_list, f_use, declarations, isfunction, returned_type, f_the_end, my_stats)


def write_fortran_interface(index, module_name, f_file_name, unix_only_file, mswindows_only_file, f_file, whole_file_original, c_dir, c_file_name, function_status, prototype, f_procedure, f_name, args_list, f_use, declarations, isfunction, returned_type, f_the_end, my_stats):
