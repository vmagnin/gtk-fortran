...
function atk_table_cell_get_row_column_span(cell, row, column, row_span,&
& column_span) bind(c)
  import :: c_int, c_ptr
  implicit none
...
subroutine atk_editable_text_insert_text(text, string, length, position)&
& bind(c)
...
subroutine atk_value_set_value(obj, new_value) bind(c)
  import :: c_ptr, c_double
  implicit none
  type(c_ptr), value :: obj
  real(c_double), value :: new_value
end subroutine
...
function atk_scroll_type_get_type() bind(c)
  import :: c_size_t
  implicit none
  integer(c_size_t) :: atk_scroll_type_get_type
end function
...
function atk_live_get_type() bind(c)
  import :: c_size_t
  implicit none
  integer(c_size_t) :: atk_live_get_type
end function
...
function atk_text_get_text_after_offset(text, offset, boundary_type,&
& start_offset, end_offset) bind(c)
  import :: c_ptr, c_int
  implicit none
...
function atk_text_get_text_before_offset(text, offset, boundary_type,&
& start_offset, end_offset) bind(c)
  import :: c_ptr, c_int
  implicit none
...
subroutine atk_text_get_range_extents(text, start_offset, end_offset,&
& coord_type, rect) bind(c)
  import :: c_ptr, c_int
  implicit none
  type(c_ptr), value :: text
  integer(c_int), value :: start_offset
...
function atk_text_get_bounded_ranges(text, rect, coord_type, x_clip_type,&
& y_clip_type) bind(c)
  import :: c_ptr, c_int
  implicit none
...
function atk_text_scroll_substring_to(text, start_offset, end_offset, type)&
& bind(c)
  import :: c_int, c_ptr
  implicit none
  integer(c_int) :: atk_text_scroll_substring_to
  type(c_ptr), value :: text
  integer(c_int), value :: start_offset
  integer(c_int), value :: end_offset
  integer(c_int), value :: type
...
function atk_text_scroll_substring_to_point(text, start_offset, end_offset,&
& coords, x, y) bind(c)
  import :: c_int, c_ptr
  implicit none
  integer(c_int) :: atk_text_scroll_substring_to_point
  type(c_ptr), value :: text
  integer(c_int), value :: start_offset
  integer(c_int), value :: end_offset
  integer(c_int), value :: coords
...
function atk_document_set_attribute_value(document, attribute_name,&
& attribute_value) bind(c)
...
function atk_document_get_text_selections(document) bind(c)
  import :: c_ptr
  implicit none
  type(c_ptr) :: atk_document_get_text_selections
  type(c_ptr), value :: document
end function

! ATK_AVAILABLE_IN_2_52
!gboolean atk_document_set_text_selections (AtkDocument *document, GArray *selections);
function atk_document_set_text_selections(document, selections) bind(c)
  import :: c_int, c_ptr
  implicit none
  integer(c_int) :: atk_document_set_text_selections
  type(c_ptr), value :: document
  type(c_ptr), value :: selections
end function
...
subroutine atk_plug_set_child(plug, child) bind(c)
  import :: c_ptr
  implicit none
...
subroutine atk_component_get_extents(component, x, y, width, height,&
& coord_type) bind(c)
  import :: c_ptr, c_int
  implicit none
  type(c_ptr), value :: component
...
function atk_component_scroll_to(component, type) bind(c)
  import :: c_int, c_ptr
  implicit none
  integer(c_int) :: atk_component_scroll_to
  type(c_ptr), value :: component
  integer(c_int), value :: type
end function
...
function atk_component_scroll_to_point(component, coords, x, y) bind(c)
  import :: c_int, c_ptr
  implicit none
  integer(c_int) :: atk_component_scroll_to_point
  type(c_ptr), value :: component
  integer(c_int), value :: coords
  integer(c_int), value :: x
  integer(c_int), value :: y
...
function atk_object_connect_property_change_handler(accessible, handler)&
& bind(c)
  import :: c_int, c_ptr, c_funptr
  implicit none
...
function atk_object_get_accessible_id(accessible) bind(c)
  import :: c_ptr
  implicit none
  type(c_ptr) :: atk_object_get_accessible_id
  type(c_ptr), value :: accessible
end function

! ATK_AVAILABLE_IN_2_36
!void atk_object_set_accessible_id (AtkObject *accessible, const gchar *id);
subroutine atk_object_set_accessible_id(accessible, id) bind(c)
  import :: c_ptr, c_char
  implicit none
  type(c_ptr), value :: accessible
...
function atk_object_get_help_text(accessible) bind(c)
  import :: c_ptr
  implicit none
  type(c_ptr) :: atk_object_get_help_text
  type(c_ptr), value :: accessible
end function

! ATK_AVAILABLE_IN_2_52
!void atk_object_set_help_text (AtkObject *accessible, const gchar *help_text);
subroutine atk_object_set_help_text(accessible, help_text) bind(c)
  import :: c_ptr, c_char
  implicit none
  type(c_ptr), value :: accessible
  character(kind=c_char), dimension(*) :: help_text
end subroutine
