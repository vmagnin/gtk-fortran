...
! gboolean atk_relation_set_contains_target (AtkRelationSet *set, AtkRelationType relationship, AtkObject *targe);
function atk_relation_set_contains_target(set, relationship, targe) bind(c) 
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: atk_relation_set_contains_target
  type(c_ptr), value :: set
  integer(c_int), value :: relationship
  type(c_ptr), value :: targe
end function
