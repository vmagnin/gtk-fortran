...
enums_file.write("! This file is automatically generated by cfwrapper.py \n")
enums_file.write("! Please do not modify \n")
enums_file.write("! GNU General Public License version 3 \n\n")
    ...
    for directory in tree:
        for c_file_name in directory[2]:
            ...
            for prototype in corrected_lines_list:
                ...
                if function_name.group(1) in ["gtk_init","g_bit_nth_lsf","g_once_init_enter"]:
                    continue    # Next prototype
