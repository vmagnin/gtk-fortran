...
! GTK 3.99.4, GLib 2.67.0, Ubuntu 34 x86_64
...
! GDK_AVAILABLE_IN_ALL
!const GskColorStop * gsk_radial_gradient_node_peek_color_stops (GskRenderNode *node, gsize *n_stops);
function gsk_radial_gradient_node_peek_color_stops(node, n_stops) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: gsk_radial_gradient_node_peek_color_stops
  type(c_ptr), value :: node
  type(c_ptr), value :: n_stops
end function
...
function gsk_radial_gradient_node_peek_center(node) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: gsk_radial_gradient_node_peek_center
  type(c_ptr), value :: node
end function
