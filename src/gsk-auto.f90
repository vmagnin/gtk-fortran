...
! gtk-fortran 4.2.0, GTK 4.6.2, GLib 2.72.1, Fedora 36 x86_64
...
! GDK_AVAILABLE_IN_4_6
!GskTransform * gsk_transform_skew (GskTransform *next, float skew_x, float skew_y) G_GNUC_WARN_UNUSED_RESULT;
...
! GDK_AVAILABLE_IN_ALL
!const GskColorStop * gsk_linear_gradient_node_get_color_stops (const GskRenderNode *node, gsize *n_stops) G_GNUC_PURE;
...
! GDK_AVAILABLE_IN_ALL
!const GskColorStop * gsk_conic_gradient_node_get_color_stops (const GskRenderNode *node, gsize *n_stops) G_GNUC_PURE;
...
! GDK_AVAILABLE_IN_ALL
!const GskColorStop * gsk_radial_gradient_node_get_color_stops (const GskRenderNode *node, gsize *n_stops) G_GNUC_PURE;
...
! GDK_AVAILABLE_IN_ALL
!GskRenderNode * gsk_container_node_get_child (const GskRenderNode *node, guint idx) G_GNUC_PURE;
...
! 
!const graphene_matrix_t * gsk_color_matrix_node_get_color_matrix (const GskRenderNode *node) G_GNUC_PURE;
...
! GDK_AVAILABLE_IN_ALL
!const GskShadow * gsk_shadow_node_get_shadow (const GskRenderNode *node, gsize i) G_GNUC_PURE;
...
! GDK_AVAILABLE_IN_ALL
!const PangoGlyphInfo *gsk_text_node_get_glyphs (const GskRenderNode *node, guint *n_glyphs) G_GNUC_PURE;
