...
! --------------------------------------------------------
! gtk-hl-tree.f90
! Generated: Tue Jul 31 14:11:51 2012 GMT
! Please do not edit this file directly,
! Edit gtk-hl-tree-tmpl.f90, and use ./mk_gtk_hl.pl to regenerate.
! Generated for GTK+ version: 3.2.0.
...
!!$GLIB>=2.32!          call g_value_set_schar(val, ichar(svalue(1:1), c_int8_t))
          ...
          call g_value_set_char(val, char(i8value, c_char))
