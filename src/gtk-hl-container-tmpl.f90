...
!!$2          box = gtk_hbox_new(grid, space)
!!$3          box = gtk_box_new(GTK_ORIENTATION_HORIZONTAL, space)
       else
!!$2          box = gtk_vbox_new(grid, space)
!!$3          box = gtk_box_new(GTK_ORIENTATION_VERTICAL, space)
       end if
    else
!!$2       box = gtk_vbox_new(grid, space)
!!$3       box = gtk_box_new(GTK_ORIENTATION_VERTICAL, space)
...
!!$3    call gtk_box_set_homogeneous(box, grid)
