...
& name='gtk_icon_source_set_filename_utf8')
  use iso_c_binding, only: c_ptr, c_char
...
& name='gtk_icon_source_get_filename_utf8')
...
& name='gtk_window_set_icon_from_file_utf8')
  use iso_c_binding, only: c_int, c_ptr, c_char
...
& name='gtk_window_set_default_icon_from_file_utf8')
...
& name='gtk_ui_manager_add_ui_from_file_utf8')
  use iso_c_binding, only: c_int, c_ptr, c_char
...
& name='gtk_rc_add_default_file_utf8')
  use iso_c_binding, only: c_char
  character(kind=c_char), dimension(*) :: filename
end subroutine
...
& name='gtk_rc_set_default_files_utf8')
  use iso_c_binding, only: c_ptr
...
& name='gtk_image_new_from_file_utf8')
  use iso_c_binding, only: c_ptr, c_char
...
& name='gtk_image_set_from_file_utf8')
  use iso_c_binding, only: c_ptr, c_char
...
& name='gtk_file_selection_set_filename_utf8')
  use iso_c_binding, only: c_ptr, c_char
...
& name='gtk_file_selection_get_filename_utf8')
  use iso_c_binding, only: c_ptr
...
& name='gtk_file_selection_get_selections_utf8')
  use iso_c_binding, only: c_ptr
...
& name='gtk_file_chooser_get_filename_utf8')
  use iso_c_binding, only: c_ptr
...
& name='gtk_file_chooser_set_filename_utf8')
  use iso_c_binding, only: c_int, c_ptr, c_char
...
& name='gtk_file_chooser_select_filename_utf8')
  use iso_c_binding, only: c_int, c_ptr, c_char
...
& name='gtk_file_chooser_unselect_filename_utf8')
  use iso_c_binding, only: c_ptr, c_char
  type(c_ptr), value :: chooser
  character(kind=c_char), dimension(*) :: filename
end subroutine
...
& name='gtk_file_chooser_get_filenames_utf8')
  use iso_c_binding, only: c_ptr
...
& name='gtk_file_chooser_set_current_folder_utf8')
  use iso_c_binding, only: c_int, c_ptr, c_char
...
& name='gtk_file_chooser_get_current_folder_utf8')
  use iso_c_binding, only: c_ptr
...
& name='gtk_file_chooser_get_preview_filename_utf8')
  use iso_c_binding, only: c_ptr
...
& name='gtk_file_chooser_add_shortcut_folder_utf8')
  use iso_c_binding, only: c_int, c_ptr, c_char
...
& bind(c, name='gtk_file_chooser_remove_shortcut_folder_utf8')
  use iso_c_binding, only: c_int, c_ptr, c_char
...
& name='gtk_file_chooser_list_shortcut_folders_utf8')
  use iso_c_binding, only: c_ptr
...
& name='gtk_icon_theme_append_search_path_utf8')
  use iso_c_binding, only: c_ptr, c_char
  type(c_ptr), value :: icon_theme
  character(kind=c_char), dimension(*) :: path
end subroutine
...
& name='gtk_icon_theme_prepend_search_path_utf8')
  use iso_c_binding, only: c_ptr, c_char
  type(c_ptr), value :: icon_theme
  character(kind=c_char), dimension(*) :: path
end subroutine
...
& name='gtk_icon_info_get_filename_utf8')
  use iso_c_binding, only: c_ptr
