...
& callback, user_data) bind(c)
  use, intrinsic :: iso_c_binding, only: c_ptr, c_size_t, c_int, c_funptr
  type(c_ptr), value :: self
...
& data, notify) bind(c)
  use, intrinsic :: iso_c_binding, only: c_char, c_size_t, c_funptr, c_ptr
...
& cancellable, callback, user_data) bind(c)
  use, intrinsic :: iso_c_binding, only: c_ptr, c_char, c_size_t, c_int, c_funptr
...
& notify) bind(c)
  use, intrinsic :: iso_c_binding, only: c_size_t, c_char, c_funptr, c_ptr
  integer(c_size_t), value :: type
  character(kind=c_char), dimension(*) :: mime_type
