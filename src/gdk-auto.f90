...
function gdk_event_send_client_message_for_display(display, event, winid)&
& bind(c)
  use iso_c_binding, only: c_int, c_ptr
...
subroutine gdk_gc_set_line_attributes(gc, line_width, line_style, cap_style,&
& join_style) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: gc
...
subroutine gdk_draw_rgb_image_dithalign(drawable, gc, x, y, width, height,&
...
subroutine gdk_draw_rgb_32_image_dithalign(drawable, gc, x, y, width, height,&
& dith, buf, rowstride, xdith, ydith) bind(c)
  use iso_c_binding, only: c_ptr, c_int, c_char
  type(c_ptr), value :: drawable
  type(c_ptr), value :: gc
  integer(c_int), value :: x
...
subroutine gdk_draw_gray_image(drawable, gc, x, y, width, height, dith, buf,&
& rowstride) bind(c)
  use iso_c_binding, only: c_ptr, c_int, c_char
  type(c_ptr), value :: drawable
  type(c_ptr), value :: gc
...
subroutine gdk_drag_find_window(context, drag_window, x_root, y_root,&
& dest_window, protocol) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: context
  type(c_ptr), value :: drag_window
  integer(c_int), value :: x_root
...
function gdk_pixmap_create_from_xpm(drawable, mask, transparent_color,&
& filename) bind(c)
...
function gdk_pixmap_colormap_create_from_xpm(drawable, colormap, mask,&
& transparent_color, filename) bind(c)
  use iso_c_binding, only: c_ptr, c_char
...
function gdk_pixmap_colormap_create_from_xpm_d(drawable, colormap, mask,&
& transparent_color, data) bind(c)
  use iso_c_binding, only: c_ptr
...
subroutine gdk_region_spans_intersect_foreach(region, spans, n_spans, sorted,&
& function, data) bind(c)
...
subroutine gdk_display_add_client_message_filter(display, message_type, func,&
& data) bind(c)
  use iso_c_binding, only: c_ptr, c_funptr
  type(c_ptr), value :: display
  type(c_ptr), value :: message_type
...
function gdk_colormap_alloc_colors(colormap, colors, n_colors, writeable,&
& best_match, success) bind(c)
  use iso_c_binding, only: c_int, c_ptr
...
function gdk_colormap_alloc_color(colormap, color, writeable, best_match)&
& bind(c)
  use iso_c_binding, only: c_int, c_ptr
...
function gdk_colors_alloc(colormap, contiguous, planes, nplanes, pixels,&
& npixels) bind(c)
  use iso_c_binding, only: c_int, c_ptr
...
subroutine gdk_window_redirect_to_drawable(window, drawable, src_x, src_y,&
...
subroutine gdk_text_extents_wc(font, text, text_length, lbearing, rbearing,&
& width, ascent, descent) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: font
  type(c_ptr), value :: text
  integer(c_int), value :: text_length
...
function gdk_spawn_on_screen(screen, working_directory, argv, envp, flags,&
& child_setup, user_data, child_pid, error) bind(c)
...
& flags, child_setup, user_data, child_pid, standard_input, standard_output,&
...
subroutine gdk_pango_renderer_set_override_color(gdk_renderer, part, color)&
& bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: gdk_renderer
  integer(c_int), value :: part
...
subroutine gdk_draw_rectangle(drawable, gc, filled, x, y, width, height)&
& bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: drawable
  type(c_ptr), value :: gc
...
subroutine gdk_draw_arc(drawable, gc, filled, x, y, width, height, angle1,&
& angle2) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: drawable
  type(c_ptr), value :: gc
...
subroutine gdk_draw_text_wc(drawable, font, gc, x, y, text, text_length)&
& bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: drawable
  type(c_ptr), value :: font
...
subroutine gdk_draw_drawable(drawable, gc, src, xsrc, ysrc, xdest, ydest,&
& width, height) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: drawable
  type(c_ptr), value :: gc
...
subroutine gdk_draw_layout_line_with_colors(drawable, gc, x, y, line,&
& foreground, background) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: drawable
  type(c_ptr), value :: gc
  integer(c_int), value :: x
...
subroutine gdk_draw_glyphs_transformed(drawable, gc, matrix, font, x, y,&
& glyphs) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: drawable
  type(c_ptr), value :: gc
...
function gdk_drawable_copy_to_image(drawable, image, src_x, src_y, dest_x,&
& dest_y, width, height) bind(c)
  use iso_c_binding, only: c_ptr, c_int
...
subroutine gdk_display_manager_set_default_display(display_manager, display)&
& bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: display_manager
  type(c_ptr), value :: display
...
subroutine gdk_pixbuf_render_threshold_alpha(pixbuf, bitmap, src_x, src_y,&
...
subroutine gdk_pixbuf_render_to_drawable(pixbuf, drawable, gc, src_x, src_y,&
...
subroutine gdk_pixbuf_render_pixmap_and_mask_for_colormap(pixbuf, colormap,&
& pixmap_return, mask_return, alpha_threshold) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: pixbuf
  type(c_ptr), value :: colormap
...
subroutine gdk_pixbuf_render_pixmap_and_mask(pixbuf, pixmap_return,&
& mask_return, alpha_threshold) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: pixbuf
  type(c_ptr), value :: pixmap_return
  type(c_ptr), value :: mask_return
...
function gdk_pixbuf_get_from_drawable(dest, src, cmap, src_x, src_y, dest_x,&
& dest_y, width, height) bind(c)
  use iso_c_binding, only: c_ptr, c_int
...
function gdk_pixbuf_get_from_image(dest, src, cmap, src_x, src_y, dest_x,&
& dest_y, width, height) bind(c)
  use iso_c_binding, only: c_ptr, c_int
...
function gdk_text_property_to_text_list(encoding, format, text, length, list)&
& bind(c)
  use iso_c_binding, only: c_int, c_ptr, c_char
...
function gdk_utf8_to_compound_text(str, encoding, format, ctext, length)&
& bind(c)
  use iso_c_binding, only: c_int, c_char, c_ptr
...
function gdk_string_to_compound_text(str, encoding, format, ctext, length)&
& bind(c)
  use iso_c_binding, only: c_int, c_char, c_ptr
...
function gdk_text_property_to_utf8_list(encoding, format, text, length, list)&
& bind(c)
  use iso_c_binding, only: c_int, c_ptr, c_char
...
function gdk_string_to_compound_text_for_display(display, str, encoding,&
& format, ctext, length) bind(c)
  use iso_c_binding, only: c_int, c_ptr, c_char
