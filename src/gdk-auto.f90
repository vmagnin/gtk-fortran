...
function gdk_seat_get_master_pointers(seat, capabilities) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr) :: gdk_seat_get_master_pointers
  type(c_ptr), value :: seat
  integer(c_int), value :: capabilities
end function
...
! GDK_AVAILABLE_IN_ALL
!void gdk_cairo_surface_upload_to_gl (cairo_surface_t *surface, int target, int width, int height, GdkGLContext *context);
subroutine gdk_cairo_surface_upload_to_gl(surface, target, width, height,&
& context) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: surface
...
function gdk_surface_new_toplevel(display, width, height) bind(c)
  use iso_c_binding, only: c_ptr, c_int
...
function gdk_surface_is_viewable(surface) bind(c)
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: gdk_surface_is_viewable
  type(c_ptr), value :: surface
end function
...
subroutine gdk_surface_get_device_position(surface, device, x, y, mask) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: surface
  type(c_ptr), value :: device
  type(c_ptr), value :: x
...
subroutine gdk_surface_begin_resize_drag(surface, edge, device, button, x, y,&
& timestamp) bind(c)
...
subroutine gdk_surface_begin_move_drag(surface, device, button, x, y,&
& timestamp) bind(c)
  use iso_c_binding, only: c_ptr, c_int, c_int32_t
  type(c_ptr), value :: surface
  type(c_ptr), value :: device
...
subroutine gdk_surface_queue_expose(surface) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: surface
end subroutine
...
subroutine gdk_surface_freeze_updates(surface) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: surface
end subroutine
...
subroutine gdk_surface_thaw_updates(surface) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: surface
end subroutine
...
subroutine gdk_surface_constrain_size(geometry, flags, width, height,&
& new_width, new_height) bind(c)
  use iso_c_binding, only: c_ptr, c_int
...
subroutine gdk_surface_set_support_multidevice(surface, support_multidevice)&
& bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: surface
...
function gdk_surface_get_support_multidevice(surface) bind(c)
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: gdk_surface_get_support_multidevice
  type(c_ptr), value :: surface
end function
...
subroutine gdk_surface_set_shadow_width(surface, left, right, top, bottom)&
& bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: surface
...
function gdk_display_get_keymap(display) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: gdk_display_get_keymap
  type(c_ptr), value :: display
end function
...
function gdk_toplevel_layout_new(min_width, min_height) bind(c)
  use iso_c_binding, only: c_ptr, c_int
...
function gdk_toplevel_layout_get_min_width(layout) bind(c)
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: gdk_toplevel_layout_get_min_width
  type(c_ptr), value :: layout
end function

! GDK_AVAILABLE_IN_ALL
!int gdk_toplevel_layout_get_min_height (GdkToplevelLayout *layout);
function gdk_toplevel_layout_get_min_height(layout) bind(c)
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: gdk_toplevel_layout_get_min_height
  type(c_ptr), value :: layout
end function

! GDK_AVAILABLE_IN_ALL
!gboolean gdk_toplevel_layout_get_maximized (GdkToplevelLayout *layout);
function gdk_toplevel_layout_get_maximized(layout) bind(c)
  use iso_c_binding, only: c_int, c_ptr
...
function gdk_toplevel_layout_get_fullscreen(layout) bind(c)
  use iso_c_binding, only: c_int, c_ptr
...
! GDK_AVAILABLE_IN_ALL
!GdkDrag * gdk_drag_begin (GdkSurface *surface, GdkDevice *device, GdkContentProvider *content, GdkDragAction actions, gint dx, gint dy);
...
! GDK_AVAILABLE_IN_ALL
!void gdk_drag_set_hotspot (GdkDrag *drag, gint hot_x, gint hot_y);
...
& data, notify) bind(c)
  use iso_c_binding, only: c_char, c_size_t, c_funptr, c_ptr
...
function gdk_key_event_get_scancode(event) bind(c)
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: gdk_key_event_get_scancode
  type(c_ptr), value :: event
end function

! GDK_AVAILABLE_IN_ALL
!guint gdk_key_event_get_group (GdkEvent *event);
function gdk_key_event_get_group(event) bind(c)
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: gdk_key_event_get_group
  type(c_ptr), value :: event
end function
...
! GDK_AVAILABLE_IN_ALL
!void gdk_configure_event_get_size (GdkEvent *event, int *width, int *height);
subroutine gdk_configure_event_get_size(event, width, height) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: event
...
function gdk_touchpad_pinch_event_get_angle_delta(event) bind(c)
  use iso_c_binding, only: c_double, c_ptr
  real(c_double) :: gdk_touchpad_pinch_event_get_angle_delta
  type(c_ptr), value :: event
end function

! GDK_AVAILABLE_IN_ALL
!double gdk_touchpad_pinch_event_get_scale (GdkEvent *event);
function gdk_touchpad_pinch_event_get_scale(event) bind(c)
  use iso_c_binding, only: c_double, c_ptr
  real(c_double) :: gdk_touchpad_pinch_event_get_scale
  type(c_ptr), value :: event
end function

! GDK_AVAILABLE_IN_ALL
!guint gdk_pad_button_event_get_button (GdkEvent *event);
function gdk_pad_button_event_get_button(event) bind(c)
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: gdk_pad_button_event_get_button
  type(c_ptr), value :: event
end function

! GDK_AVAILABLE_IN_ALL
!void gdk_pad_axis_event_get_value (GdkEvent *event, guint *index, double *value);
subroutine gdk_pad_axis_event_get_value(event, index, value) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: event
...
function gdk_drag_event_get_drop(event) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: gdk_drag_event_get_drop
  type(c_ptr), value :: event
end function
...
function gdk_event_get_motion_history(event) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: gdk_event_get_motion_history
  type(c_ptr), value :: event
end function
...
function gdk_keymap_get_display(keymap) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: gdk_keymap_get_display
...
! GDK_AVAILABLE_IN_ALL
!void gdk_device_get_state (GdkDevice *device, GdkSurface *surface, gdouble *axes, GdkModifierType *mask);
subroutine gdk_device_get_state(device, surface, axes, mask) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: device
  type(c_ptr), value :: surface
  type(c_ptr), value :: axes
...
! GDK_AVAILABLE_IN_ALL
!gboolean gdk_device_get_history (GdkDevice *device, GdkSurface *surface, guint32 start, guint32 stop, GdkTimeCoord ***events, gint *n_events);
function gdk_device_get_history(device, surface, start, stop, events, n_events)&
& bind(c)
...
function gdk_device_get_axis_names(device) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: gdk_device_get_axis_names
  type(c_ptr), value :: device
end function

! GDK_AVAILABLE_IN_ALL
!gboolean gdk_device_get_axis_value (GdkDevice *device, gdouble *axes, const char *axis_label, gdouble *value);
function gdk_device_get_axis_value(device, axes, axis_label, value) bind(c)
  use iso_c_binding, only: c_int, c_ptr, c_char
  integer(c_int) :: gdk_device_get_axis_value
  type(c_ptr), value :: device
  type(c_ptr), value :: axes
  character(kind=c_char), dimension(*) :: axis_label
  type(c_ptr), value :: value
end function
...
function gdk_device_get_last_event_surface(device) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: gdk_device_get_last_event_surface
  type(c_ptr), value :: device
end function
...
& notify) bind(c)
  use iso_c_binding, only: c_size_t, c_char, c_funptr, c_ptr
  integer(c_size_t), value :: type
  character(kind=c_char), dimension(*) :: mime_type
...
! GDK_AVAILABLE_IN_ALL
!GdkSurface * gdk_wayland_surface_new_subsurface (GdkDisplay *display, const GdkRectangle *position);
function gdk_wayland_surface_new_subsurface(display, position) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: gdk_wayland_surface_new_subsurface
  type(c_ptr), value :: display
  type(c_ptr), value :: position
end function

! GDK_AVAILABLE_IN_ALL
!void gdk_wayland_surface_set_dbus_properties_libgtk_only (GdkSurface *surface, const char *application_id, const char *app_menu_path, const char *menubar_path, const char *window_object_path, const char *application_object_path, const char *unique_bus_name);
subroutine gdk_wayland_surface_set_dbus_properties_libgtk_only(surface,&
...
! GDK_AVAILABLE_IN_ALL
!gboolean gdk_wayland_surface_export_handle (GdkSurface *surface, GdkWaylandSurfaceExported callback, gpointer user_data, GDestroyNotify destroy_func);
function gdk_wayland_surface_export_handle(surface, callback, user_data,&
& destroy_func) bind(c)
  use iso_c_binding, only: c_int, c_ptr, c_funptr
  integer(c_int) :: gdk_wayland_surface_export_handle
  type(c_ptr), value :: surface
  type(c_funptr), value :: callback
  type(c_ptr), value :: user_data
...
subroutine gdk_wayland_surface_unexport_handle(surface) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: surface
end subroutine

! GDK_AVAILABLE_IN_ALL
!gboolean gdk_wayland_surface_set_transient_for_exported (GdkSurface *surface, char *parent_handle_str);
function gdk_wayland_surface_set_transient_for_exported(surface,&
& parent_handle_str) bind(c)
  use iso_c_binding, only: c_int, c_ptr, c_char
  integer(c_int) :: gdk_wayland_surface_set_transient_for_exported
  type(c_ptr), value :: surface
...
subroutine gdk_wayland_surface_announce_csd(surface) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: surface
end subroutine
...
! GDK_AVAILABLE_IN_ALL
!GdkDevice * gdk_x11_device_manager_lookup (GdkX11DeviceManagerXI2 *device_manager, gint device_id);
...
! GDK_AVAILABLE_IN_ALL
!void gdk_x11_display_set_surface_scale (GdkDisplay *display, gint scale);
...
! GDK_AVAILABLE_IN_ALL
!XID gdk_x11_screen_get_monitor_output (GdkX11Screen *screen, gint monitor_num);
...
! GDK_AVAILABLE_IN_ALL
!gint gdk_x11_display_text_property_to_text_list (GdkDisplay *display, const char *encoding, gint format, const guchar *text, gint length, gchar ***list);
...
! GDK_AVAILABLE_IN_ALL
!gint gdk_x11_display_string_to_compound_text (GdkDisplay *display, const char *str, const char **encoding, gint *format, guchar **ctext, gint *length);
...
! GDK_AVAILABLE_IN_ALL
!gboolean gdk_x11_display_utf8_to_compound_text (GdkDisplay *display, const char *str, const char **encoding, gint *format, guchar **ctext, gint *length);
...
function gdk_broadway_get_last_seen_time(surface) bind(c)
  use iso_c_binding, only: c_int32_t, c_ptr
