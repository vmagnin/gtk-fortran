...
! GDK_AVAILABLE_IN_ALL
!void gdk_wayland_device_pad_set_feedback (GdkDevice *device, GdkDevicePadFeature feature, guint feature_idx, const char *label);
subroutine gdk_wayland_device_pad_set_feedback(device, feature, feature_idx,&
& label) bind(c)
...
! GDK_AVAILABLE_IN_ALL
!void gdk_wayland_toplevel_set_dbus_properties_libgtk_only (GdkToplevel *toplevel, const char *application_id, const char *app_menu_path, const char *menubar_path, const char *window_object_path, const char *application_object_path, const char *unique_bus_name);
subroutine gdk_wayland_toplevel_set_dbus_properties_libgtk_only(toplevel,&
...
subroutine gdk_wayland_toplevel_announce_csd(toplevel) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: toplevel
end subroutine
...
function gdk_wayland_toplevel_inhibit_idle(toplevel) bind(c)
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: gdk_wayland_toplevel_inhibit_idle
  type(c_ptr), value :: toplevel
end function

! 
!void gdk_wayland_toplevel_uninhibit_idle (GdkToplevel *toplevel);
subroutine gdk_wayland_toplevel_uninhibit_idle(toplevel) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: toplevel
end subroutine
