...
function gdk_x11_device_xi_get_type() bind(c) 
  use iso_c_binding, only: c_size_t
  integer(c_size_t) :: gdk_x11_device_xi_get_type
end function
...
function gdk_x11_device_manager_xi_get_type() bind(c) 
  use iso_c_binding, only: c_size_t
  integer(c_size_t) :: gdk_x11_device_manager_xi_get_type
end function
