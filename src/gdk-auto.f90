...
subroutine gdk_window_set_shadow_width(window, left, right, top, bottom) bind(c&
&)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: window
...
subroutine gdk_cairo_draw_from_gl(cr, window, source, source_type, buffer_scale&
&, x, y, width, height) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: cr
  type(c_ptr), value :: window
  integer(c_int), value :: source
...
! GdkWindow * gdk_wayland_drag_context_get_dnd_window (GdkDragContext *context);
function gdk_wayland_drag_context_get_dnd_window(context) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: gdk_wayland_drag_context_get_dnd_window
  type(c_ptr), value :: context
end function
