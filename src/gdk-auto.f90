...
! gtk-fortran 4.4.1, GTK 4.10.4, GLib 2.76.3, Fedora 38 x86_64
...
function gdk_vulkan_context_get_queue_family_index(context) bind(c)
  import :: c_int32_t, c_ptr
  implicit none
  integer(c_int32_t) :: gdk_vulkan_context_get_queue_family_index
  type(c_ptr), value :: context
end function

! GDK_AVAILABLE_IN_ALL
!uint32_t gdk_vulkan_context_get_n_images (GdkVulkanContext *context);
function gdk_vulkan_context_get_n_images(context) bind(c)
  import :: c_int32_t, c_ptr
  implicit none
  integer(c_int32_t) :: gdk_vulkan_context_get_n_images
  type(c_ptr), value :: context
end function

! GDK_AVAILABLE_IN_ALL
!uint32_t gdk_vulkan_context_get_draw_index (GdkVulkanContext *context);
function gdk_vulkan_context_get_draw_index(context) bind(c)
  import :: c_int32_t, c_ptr
  implicit none
  integer(c_int32_t) :: gdk_vulkan_context_get_draw_index
  type(c_ptr), value :: context
end function
