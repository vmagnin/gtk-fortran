...
! gtk-fortran 3.24.49, GTK 3.24.49, GLib 2.84.1, Fedora 42 x86_64
...
& group, keyval, effective_group, level, consumed_modifiers) bind(c)
  ...
  type(c_ptr), value :: consumed_modifiers
end function
