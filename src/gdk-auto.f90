...
! GDK_AVAILABLE_IN_ALL
!gboolean gdk_toplevel_layout_get_maximized (GdkToplevelLayout *layout, gboolean *maximize);
function gdk_toplevel_layout_get_maximized(layout, maximize) bind(c)
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: gdk_toplevel_layout_get_maximized
  type(c_ptr), value :: layout
  type(c_ptr), value :: maximize
end function
