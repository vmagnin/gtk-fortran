...
& time_) bind(c)
  use, intrinsic :: iso_c_binding, only: c_int, c_ptr, c_int32_t
...
& targets, n_targets) bind(c)
  use, intrinsic :: iso_c_binding, only: c_ptr, c_int32_t, c_int
  type(c_ptr), value :: display
...
function gdk_x11_get_xatom_by_name_for_display(display, atom_name) bind(c)
  use, intrinsic :: iso_c_binding, only: c_long, c_ptr, c_char
...
function gdk_x11_screen_get_monitor_output(screen, monitor_num) bind(c)
  use, intrinsic :: iso_c_binding, only: c_long, c_ptr, c_int
