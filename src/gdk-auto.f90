...
! GDK_AVAILABLE_IN_3_4 void gdk_window_begin_resize_drag_for_device (GdkWindow *window, GdkWindowEdge edge, GdkDevice *device, gint button, gint root_x, gint root_y, guint32 timestamp);
...
! GDK_AVAILABLE_IN_3_4 void gdk_window_begin_move_drag_for_device (GdkWindow *window, GdkDevice *device, gint button, gint root_x, gint root_y, guint32 timestamp);
...
!  GDK_AVAILABLE_IN_3_4 GdkEventSequence *gdk_event_get_event_sequence (const GdkEvent *event);
...
! GDK_AVAILABLE_IN_3_2 void gdk_x11_window_set_theme_variant (GdkWindow *window, char *variant);
...
! GDK_AVAILABLE_IN_3_4 void gdk_x11_window_set_hide_titlebar_when_maximized (GdkWindow *window, gboolean hide_titlebar_when_maximized);
...
!   GDK_AVAILABLE_IN_3_2 GdkDevice * gdk_x11_device_manager_lookup (GdkDeviceManager *device_manager, gint device_id);
...
!  gint gdk_x11_keymap_get_group_for_state_libgtk_only (GdkKeymap *keymap, guint state);
function gdk_x11_keymap_get_group_for_state_libgtk_only(keymap, state) bind(c) 
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: gdk_x11_keymap_get_group_for_state_libgtk_only
  type(c_ptr), value :: keymap
  integer(c_int), value :: state
end function

!  gboolean gdk_x11_keymap_key_is_modifier_libgtk_only (GdkKeymap *keymap, guint keycode);
function gdk_x11_keymap_key_is_modifier_libgtk_only(keymap, keycode) bind(c) 
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: gdk_x11_keymap_key_is_modifier_libgtk_only
  type(c_ptr), value :: keymap
