...
! GDK_AVAILABLE_IN_ALL
!GdkTimeCoord * gdk_motion_event_get_history (GdkEvent *event, guint *out_n_coords);
function gdk_motion_event_get_history(event, out_n_coords) bind(c)
  use iso_c_binding, only: c_ptr
...
function gdk_x11_display_get_primary_monitor(self) bind(c)
  use iso_c_binding, only: c_ptr
