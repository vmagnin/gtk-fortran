...
function gdk_window_get_device_position_double(window, device, x, y, mask) bind&
&(c) 
  use iso_c_binding, only: c_ptr, c_int
...
function gdk_cairo_surface_create_from_pixbuf(pixbuf, scale, for_window) bind(c&
&) 
  use iso_c_binding, only: c_ptr, c_int
...
!   int gdk_wayland_device_get_selection_type_atoms (GdkDevice *device, GdkAtom **atoms_out);
function gdk_wayland_device_get_selection_type_atoms(device, atoms_out) bind(c) 
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: gdk_wayland_device_get_selection_type_atoms
  type(c_ptr), value :: device
  type(c_ptr), value :: atoms_out
end function

!  gboolean gdk_wayland_device_request_selection_content (GdkDevice *device, const gchar *requested_mime_type, GdkDeviceWaylandRequestContentCallback cb, gpointer userdata);
function gdk_wayland_device_request_selection_content(device, requested_mime_ty&
&pe, cb, userdata) bind(c) 
  use iso_c_binding, only: c_int, c_ptr, c_char, c_funptr
  integer(c_int) :: gdk_wayland_device_request_selection_content
  type(c_ptr), value :: device
  character(kind=c_char), dimension(*) :: requested_mime_type
  type(c_funptr), value :: cb
  type(c_ptr), value :: userdata
end function

!  gboolean gdk_wayland_device_offer_selection_content (GdkDevice *gdk_device, const gchar **mime_types, gint nr_mime_types, GdkDeviceWaylandOfferContentCallback cb, gpointer userdata);
function gdk_wayland_device_offer_selection_content(gdk_device, mime_types, nr_&
&mime_types, cb, userdata) bind(c) 
  use iso_c_binding, only: c_int, c_ptr, c_funptr
  integer(c_int) :: gdk_wayland_device_offer_selection_content
  type(c_ptr), value :: gdk_device
  type(c_ptr), dimension(*) :: mime_types
  integer(c_int), value :: nr_mime_types
  type(c_funptr), value :: cb
  type(c_ptr), value :: userdata
end function

!  gboolean gdk_wayland_device_clear_selection_content (GdkDevice *gdk_device);
function gdk_wayland_device_clear_selection_content(gdk_device) bind(c) 
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: gdk_wayland_device_clear_selection_content
  type(c_ptr), value :: gdk_device
end function
...
subroutine gdk_x11_window_set_frame_extents(window, left, right, top, bottom) b&
&ind(c) 
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: window
...
subroutine gdk_x11_window_set_frame_sync_enabled(window, frame_sync_enabled) bi&
&nd(c) 
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: window
