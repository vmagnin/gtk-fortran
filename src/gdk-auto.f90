...
! GTK 3.98.3, GLib 2.64.2, Ubuntu 32 x86_64
...
function gdk_configure_event_get_type() bind(c)
  use iso_c_binding, only: c_size_t
  integer(c_size_t) :: gdk_configure_event_get_type
end function
...
function gdk_motion_event_get_history(event) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: gdk_motion_event_get_history
  type(c_ptr), value :: event
end function
