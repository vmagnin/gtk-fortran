...
!!$2       & gtk_hscale_new_with_range, gtk_vscale_new_with_range,&
!!$3       & gtk_scale_new_with_range,&
...
!!$2       slider = gtk_vscale_new_with_range(vmin, vmax, step)
!!$3       slider = gtk_scale_new_with_range(GTK_ORIENTATION_VERTICAL, &
!!$3            & vmin, vmax, step)
       if (present(length)) &
            & call gtk_widget_set_size_request(slider, 0, length)
    else
!!$2       slider = gtk_hscale_new_with_range(vmin, vmax, step)
!!$3       slider = gtk_scale_new_with_range(GTK_ORIENTATION_HORIZONTAL, &
!!$3            & vmin, vmax, step)
       if (present(length)) &
