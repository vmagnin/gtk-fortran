...
module gtk_hl_button
  ...
  ! autogenerated use's
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! NOT AVAILABLE in GTK 4:   gtk_widget_add_accelerator
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
       if (present(accel_key) .and. present(accel_group)) &
            & print *, "Not in GTK 4: call hl_gtk_widget_add_accelerator(but,"
            !"clicked"//c_null_char, & & accel_group, accel_key, accel_mods, accel_flags)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    end if
