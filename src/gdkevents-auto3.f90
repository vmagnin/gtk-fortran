! Automatically generated by extract_events.pl on Tue Apr 23 08:55:46 2019 Z
...
module gdk_events
  ...
  type, bind(c) :: GdkEventScroll
    ...
    integer(kind=c_int) :: is_stop = 1  ! guint
  ...
  type, bind(c) :: GdkEventTouchpadSwipe
    integer(kind=c_int) :: type    ! enum GdkEventType
    type(c_ptr) :: window   ! -> GdkWindow
    integer(kind=c_int8_t) :: send_event  ! gint8
    integer(kind=c_int8_t) :: phase  ! gint8
    integer(kind=c_int8_t) :: n_fingers  ! gint8
    integer(kind=c_int32_t) :: time  ! guint32
    real(kind=c_double) :: x  ! gdouble
    real(kind=c_double) :: y  ! gdouble
    real(kind=c_double) :: dx  ! gdouble
    real(kind=c_double) :: dy  ! gdouble
    real(kind=c_double) :: x_root, y_root  ! gdouble
    integer(kind=c_int) :: state  ! guint
  end type GdkEventTouchpadSwipe

  type, bind(c) :: GdkEventTouchpadPinch
    integer(kind=c_int) :: type    ! enum GdkEventType
    type(c_ptr) :: window   ! -> GdkWindow
    integer(kind=c_int8_t) :: send_event  ! gint8
    integer(kind=c_int8_t) :: phase  ! gint8
    ...
    real(kind=c_double) :: dx  ! gdouble
    real(kind=c_double) :: dy  ! gdouble
    real(kind=c_double) :: angle_delta  ! gdouble
    real(kind=c_double) :: scale  ! gdouble
    real(kind=c_double) :: x_root, y_root  ! gdouble
    integer(kind=c_int) :: state  ! guint
  end type GdkEventTouchpadPinch

  type, bind(c) :: GdkEventPadButton
    integer(kind=c_int) :: type    ! enum GdkEventType
    type(c_ptr) :: window   ! -> GdkWindow
    integer(kind=c_int8_t) :: send_event  ! gint8
    integer(kind=c_int32_t) :: time  ! guint32
    integer(kind=c_int) :: group  ! guint
    integer(kind=c_int) :: button  ! guint
    integer(kind=c_int) :: mode  ! guint
  end type GdkEventPadButton

  type, bind(c) :: GdkEventPadAxis
    integer(kind=c_int) :: type    ! enum GdkEventType
    type(c_ptr) :: window   ! -> GdkWindow
    integer(kind=c_int8_t) :: send_event  ! gint8
    integer(kind=c_int32_t) :: time  ! guint32
    integer(kind=c_int) :: group  ! guint
    integer(kind=c_int) :: index  ! guint
    integer(kind=c_int) :: mode  ! guint
    real(kind=c_double) :: value  ! gdouble
  end type GdkEventPadAxis

  type, bind(c) :: GdkEventPadGroupMode
    integer(kind=c_int) :: type    ! enum GdkEventType
    type(c_ptr) :: window   ! -> GdkWindow
    integer(kind=c_int8_t) :: send_event  ! gint8
    integer(kind=c_int32_t) :: time  ! guint32
