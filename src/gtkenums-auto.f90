...
! GTK 3.98.2, GLib 2.64.2, Ubuntu 32 x86_64
...
enum, bind(c)    !GdkSurfaceState
  enumerator :: GDK_SURFACE_STATE_WITHDRAWN = ISHFTC(1, 0)
  enumerator :: GDK_SURFACE_STATE_MINIMIZED = ISHFTC(1, 1)
  enumerator :: GDK_SURFACE_STATE_MAXIMIZED = ISHFTC(1, 2)
  enumerator :: GDK_SURFACE_STATE_STICKY = ISHFTC(1, 3)
  enumerator :: GDK_SURFACE_STATE_FULLSCREEN = ISHFTC(1, 4)
  enumerator :: GDK_SURFACE_STATE_ABOVE = ISHFTC(1, 5)
  enumerator :: GDK_SURFACE_STATE_BELOW = ISHFTC(1, 6)
  enumerator :: GDK_SURFACE_STATE_FOCUSED = ISHFTC(1, 7)
  enumerator :: GDK_SURFACE_STATE_TILED = ISHFTC(1, 8)
  enumerator :: GDK_SURFACE_STATE_TOP_TILED = ISHFTC(1, 9)
  enumerator :: GDK_SURFACE_STATE_TOP_RESIZABLE = ISHFTC(1, 10)
  enumerator :: GDK_SURFACE_STATE_RIGHT_TILED = ISHFTC(1, 11)
  enumerator :: GDK_SURFACE_STATE_RIGHT_RESIZABLE = ISHFTC(1, 12)
  enumerator :: GDK_SURFACE_STATE_BOTTOM_TILED = ISHFTC(1, 13)
  enumerator :: GDK_SURFACE_STATE_BOTTOM_RESIZABLE = ISHFTC(1, 14)
  enumerator :: GDK_SURFACE_STATE_LEFT_TILED = ISHFTC(1, 15)
  enumerator :: GDK_SURFACE_STATE_LEFT_RESIZABLE = ISHFTC(1, 16)
end enum
...
enum, bind(c)    !GdkModifierType
  ...
  enumerator :: GDK_MODIFIER_RESERVED_30_MASK = ISHFTC(1, 30)
  enumerator :: GDK_MODIFIER_MASK = INT(z'1c001fff')
end enum
...
enum, bind(c)    !GdkGrabOwnership
  ...
  enumerator :: GDK_OWNERSHIP_SURFACE
...
enum, bind(c)    !GdkSurfaceTypeHint
  enumerator :: GDK_SURFACE_TYPE_HINT_NORMAL
  enumerator :: GDK_SURFACE_TYPE_HINT_DIALOG
  enumerator :: GDK_SURFACE_TYPE_HINT_MENU
  enumerator :: GDK_SURFACE_TYPE_HINT_TOOLBAR
  enumerator :: GDK_SURFACE_TYPE_HINT_SPLASHSCREEN
  enumerator :: GDK_SURFACE_TYPE_HINT_UTILITY
  enumerator :: GDK_SURFACE_TYPE_HINT_DOCK
  enumerator :: GDK_SURFACE_TYPE_HINT_DESKTOP
  enumerator :: GDK_SURFACE_TYPE_HINT_DROPDOWN_MENU
  enumerator :: GDK_SURFACE_TYPE_HINT_POPUP_MENU
  enumerator :: GDK_SURFACE_TYPE_HINT_TOOLTIP
  enumerator :: GDK_SURFACE_TYPE_HINT_NOTIFICATION
  enumerator :: GDK_SURFACE_TYPE_HINT_COMBO
  enumerator :: GDK_SURFACE_TYPE_HINT_DND
end enum
...
enum, bind(c)    !GtkDebugFlag
  ...
  enumerator :: GTK_DEBUG_BUILDER = ISHFTC(1, 7)
  enumerator :: GTK_DEBUG_SIZE_REQUEST = ISHFTC(1, 8)
  enumerator :: GTK_DEBUG_NO_CSS_CACHE = ISHFTC(1, 9)
  enumerator :: GTK_DEBUG_INTERACTIVE = ISHFTC(1, 11)
  enumerator :: GTK_DEBUG_TOUCHSCREEN = ISHFTC(1, 12)
  enumerator :: GTK_DEBUG_ACTIONS = ISHFTC(1, 13)
  enumerator :: GTK_DEBUG_RESIZE = ISHFTC(1, 14)
  enumerator :: GTK_DEBUG_LAYOUT = ISHFTC(1, 15)
  enumerator :: GTK_DEBUG_SNAPSHOT = ISHFTC(1, 16)
  enumerator :: GTK_DEBUG_CONSTRAINTS = ISHFTC(1, 17)
end enum
...
enum, bind(c)    !GtkShortcutTriggerMatch
  enumerator :: GTK_SHORTCUT_TRIGGER_MATCH_NONE
  enumerator :: GTK_SHORTCUT_TRIGGER_MATCH_PARTIAL
  enumerator :: GTK_SHORTCUT_TRIGGER_MATCH_EXACT
end enum
