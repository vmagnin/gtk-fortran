! Automatically generated by cfwrapper.py, do not modify !
...
enum, bind(c)    !GdkAnchorHints
  ...
  enumerator :: GDK_ANCHOR_RESIZE = ior(GDK_ANCHOR_RESIZE_X , GDK_ANCHOR_RESIZE&
&_Y)
end enum
...
enum, bind(c)    !GdkEventMask
  ...
  enumerator :: GDK_ALL_EVENTS_MASK = INT(z'FFFFFE')
end enum
...
enum, bind(c)    !GtkJunctionSides
  ...
  enumerator :: GTK_JUNCTION_TOP = ior(GTK_JUNCTION_CORNER_TOPLEFT , GTK_JUNCTI&
&ON_CORNER_TOPRIGHT)
  enumerator :: GTK_JUNCTION_BOTTOM = ior(GTK_JUNCTION_CORNER_BOTTOMLEFT , GTK_&
&JUNCTION_CORNER_BOTTOMRIGHT)
  enumerator :: GTK_JUNCTION_LEFT = ior(GTK_JUNCTION_CORNER_TOPLEFT , GTK_JUNCT&
&ION_CORNER_BOTTOMLEFT)
  enumerator :: GTK_JUNCTION_RIGHT = ior(GTK_JUNCTION_CORNER_TOPRIGHT , GTK_JUN&
&CTION_CORNER_BOTTOMRIGHT)
end enum
