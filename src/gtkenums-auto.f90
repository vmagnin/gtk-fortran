...
! GTK 3.24.28, GLib 2.68.1, Fedora 34 x86_64
...
enum, bind(c)    !AtkValueType
  ...
  enumerator :: ATK_VALUE_WEAK
  enumerator :: ATK_VALUE_ACCEPTABLE
  enumerator :: ATK_VALUE_STRONG
  enumerator :: ATK_VALUE_VERY_STRONG
  enumerator :: ATK_VALUE_VERY_LOW
  enumerator :: ATK_VALUE_LOW
  enumerator :: ATK_VALUE_MEDIUM
  enumerator :: ATK_VALUE_HIGH
  enumerator :: ATK_VALUE_VERY_HIGH
  enumerator :: ATK_VALUE_VERY_BAD
  enumerator :: ATK_VALUE_BAD
  enumerator :: ATK_VALUE_GOOD
  enumerator :: ATK_VALUE_VERY_GOOD
  enumerator :: ATK_VALUE_BEST
...
enum, bind(c)    !AtkTextAttribute
  ...
  enumerator :: ATK_TEXT_ATTR_TEXT_POSITION
...
enum, bind(c)    !AtkCoordType
  ...
  enumerator :: ATK_XY_PARENT
end enum

! atksocket.h
! atkplug.h
! atkcomponent.h
enum, bind(c)    !AtkScrollType
  enumerator :: ATK_SCROLL_TOP_LEFT
  enumerator :: ATK_SCROLL_BOTTOM_RIGHT
  enumerator :: ATK_SCROLL_TOP_EDGE
  enumerator :: ATK_SCROLL_BOTTOM_EDGE
  enumerator :: ATK_SCROLL_LEFT_EDGE
  enumerator :: ATK_SCROLL_RIGHT_EDGE
  enumerator :: ATK_SCROLL_ANYWHERE
end enum
...
enum, bind(c)    !AtkRole
  ...
  enumerator :: ATK_ROLE_LEVEL_BAR
  enumerator :: ATK_ROLE_TITLE_BAR
  enumerator :: ATK_ROLE_BLOCK_QUOTE
  enumerator :: ATK_ROLE_AUDIO
  enumerator :: ATK_ROLE_VIDEO
  enumerator :: ATK_ROLE_DEFINITION
  enumerator :: ATK_ROLE_ARTICLE
  enumerator :: ATK_ROLE_LANDMARK
  enumerator :: ATK_ROLE_LOG
  enumerator :: ATK_ROLE_MARQUEE
  enumerator :: ATK_ROLE_MATH
  enumerator :: ATK_ROLE_RATING
  enumerator :: ATK_ROLE_TIMER
  enumerator :: ATK_ROLE_DESCRIPTION_LIST
  enumerator :: ATK_ROLE_DESCRIPTION_TERM
  enumerator :: ATK_ROLE_DESCRIPTION_VALUE
  enumerator :: ATK_ROLE_STATIC
  enumerator :: ATK_ROLE_MATH_FRACTION
  enumerator :: ATK_ROLE_MATH_ROOT
  enumerator :: ATK_ROLE_SUBSCRIPT
  enumerator :: ATK_ROLE_SUPERSCRIPT
  enumerator :: ATK_ROLE_FOOTNOTE
  enumerator :: ATK_ROLE_CONTENT_DELETION
  enumerator :: ATK_ROLE_CONTENT_INSERTION
  enumerator :: ATK_ROLE_MARK
  enumerator :: ATK_ROLE_SUGGESTION
...
enum, bind(c)    !GdkModifierType
  ...
  enumerator :: GDK_MODIFIER_RESERVED_13_MASK = ISHFTC(1, 13)
  enumerator :: GDK_MODIFIER_RESERVED_14_MASK = ISHFTC(1, 14)
  enumerator :: GDK_MODIFIER_RESERVED_15_MASK = ISHFTC(1, 15)
  enumerator :: GDK_MODIFIER_RESERVED_16_MASK = ISHFTC(1, 16)
  enumerator :: GDK_MODIFIER_RESERVED_17_MASK = ISHFTC(1, 17)
  enumerator :: GDK_MODIFIER_RESERVED_18_MASK = ISHFTC(1, 18)
  enumerator :: GDK_MODIFIER_RESERVED_19_MASK = ISHFTC(1, 19)
  enumerator :: GDK_MODIFIER_RESERVED_20_MASK = ISHFTC(1, 20)
  enumerator :: GDK_MODIFIER_RESERVED_21_MASK = ISHFTC(1, 21)
  enumerator :: GDK_MODIFIER_RESERVED_22_MASK = ISHFTC(1, 22)
  enumerator :: GDK_MODIFIER_RESERVED_23_MASK = ISHFTC(1, 23)
  enumerator :: GDK_MODIFIER_RESERVED_24_MASK = ISHFTC(1, 24)
  enumerator :: GDK_MODIFIER_RESERVED_25_MASK = ISHFTC(1, 25)
  enumerator :: GDK_SUPER_MASK = ISHFTC(1, 26)
  enumerator :: GDK_HYPER_MASK = ISHFTC(1, 27)
  enumerator :: GDK_META_MASK = ISHFTC(1, 28)
  enumerator :: GDK_MODIFIER_RESERVED_29_MASK = ISHFTC(1, 29)
  enumerator :: GDK_RELEASE_MASK = ISHFTC(1, 30)
  enumerator :: GDK_MODIFIER_MASK = INT(z'5c001fff')
end enum

enum, bind(c)    !GdkModifierIntent
  enumerator :: GDK_MODIFIER_INTENT_PRIMARY_ACCELERATOR
  enumerator :: GDK_MODIFIER_INTENT_CONTEXT_MENU
  enumerator :: GDK_MODIFIER_INTENT_EXTEND_SELECTION
  enumerator :: GDK_MODIFIER_INTENT_MODIFY_SELECTION
  enumerator :: GDK_MODIFIER_INTENT_NO_TEXT_INPUT
  enumerator :: GDK_MODIFIER_INTENT_SHIFT_GROUP
  enumerator :: GDK_MODIFIER_INTENT_DEFAULT_MOD_MASK
end enum
...
enum, bind(c)    !GdkEventMask
  ...
  enumerator :: GDK_TOUCH_MASK = ISHFTC(1, 22)
  enumerator :: GDK_SMOOTH_SCROLL_MASK = ISHFTC(1, 23)
  enumerator :: GDK_TOUCHPAD_GESTURE_MASK = ISHFTC(1, 24)
  enumerator :: GDK_TABLET_PAD_MASK = ISHFTC(1, 25)
  enumerator :: GDK_ALL_EVENTS_MASK = INT(z'3FFFFFE')
end enum
...
enum, bind(c)    !GdkEventType
  ...
  enumerator :: GDK_DOUBLE_BUTTON_PRESS = GDK_2BUTTON_PRESS
  enumerator :: GDK_3BUTTON_PRESS = 6
  enumerator :: GDK_TRIPLE_BUTTON_PRESS = GDK_3BUTTON_PRESS
  ...
  enumerator :: GDK_TOUCH_BEGIN = 37
  enumerator :: GDK_TOUCH_UPDATE = 38
  enumerator :: GDK_TOUCH_END = 39
  enumerator :: GDK_TOUCH_CANCEL = 40
  enumerator :: GDK_TOUCHPAD_SWIPE = 41
  enumerator :: GDK_TOUCHPAD_PINCH = 42
  enumerator :: GDK_PAD_BUTTON_PRESS = 43
  enumerator :: GDK_PAD_BUTTON_RELEASE = 44
  enumerator :: GDK_PAD_RING = 45
  enumerator :: GDK_PAD_STRIP = 46
  enumerator :: GDK_PAD_GROUP_MODE = 47
...
enum, bind(c)    !GdkWindowState
  ...
  enumerator :: GDK_WINDOW_STATE_FOCUSED = ISHFTC(1, 7)
  enumerator :: GDK_WINDOW_STATE_TILED = ISHFTC(1, 8)
  enumerator :: GDK_WINDOW_STATE_TOP_TILED = ISHFTC(1, 9)
  enumerator :: GDK_WINDOW_STATE_TOP_RESIZABLE = ISHFTC(1, 10)
  enumerator :: GDK_WINDOW_STATE_RIGHT_TILED = ISHFTC(1, 11)
  enumerator :: GDK_WINDOW_STATE_RIGHT_RESIZABLE = ISHFTC(1, 12)
  enumerator :: GDK_WINDOW_STATE_BOTTOM_TILED = ISHFTC(1, 13)
  enumerator :: GDK_WINDOW_STATE_BOTTOM_RESIZABLE = ISHFTC(1, 14)
  enumerator :: GDK_WINDOW_STATE_LEFT_TILED = ISHFTC(1, 15)
  enumerator :: GDK_WINDOW_STATE_LEFT_RESIZABLE = ISHFTC(1, 16)
end enum
...
enum, bind(c)    !GdkWindowType
  ...
  enumerator :: GDK_WINDOW_SUBSURFACE
end enum
...
enum, bind(c)    !GdkWindowAttributesType
  ...
  enumerator :: GDK_WA_VISUAL = ISHFTC(1, 5)
  enumerator :: GDK_WA_WMCLASS = ISHFTC(1, 6)
  enumerator :: GDK_WA_NOREDIR = ISHFTC(1, 7)
  enumerator :: GDK_WA_TYPE_HINT = ISHFTC(1, 8)
end enum
...
enum, bind(c)    !GdkDragProtocol
  ...
  enumerator :: GDK_DRAG_PROTO_WAYLAND
end enum
...
enum, bind(c)    !GtkIconLookupFlags
  ...
  enumerator :: GTK_ICON_LOOKUP_FORCE_REGULAR = ISHFTC(1, 5)
  enumerator :: GTK_ICON_LOOKUP_FORCE_SYMBOLIC = ISHFTC(1, 6)
  enumerator :: GTK_ICON_LOOKUP_DIR_LTR = ISHFTC(1, 7)
  enumerator :: GTK_ICON_LOOKUP_DIR_RTL = ISHFTC(1, 8)
end enum
...
! gtkplacessidebar.h
enum, bind(c)    !GtkPlacesOpenFlags
  enumerator :: GTK_PLACES_OPEN_NORMAL = ISHFTC(1, 0)
  enumerator :: GTK_PLACES_OPEN_NEW_TAB = ISHFTC(1, 1)
  enumerator :: GTK_PLACES_OPEN_NEW_WINDOW = ISHFTC(1, 2)
end enum
...
enum, bind(c)    !GtkDebugFlag
  ...
  enumerator :: GTK_DEBUG_SIZE_REQUEST = ISHFTC(1, 12)
  enumerator :: GTK_DEBUG_NO_CSS_CACHE = ISHFTC(1, 13)
  enumerator :: GTK_DEBUG_BASELINES = ISHFTC(1, 14)
  enumerator :: GTK_DEBUG_PIXEL_CACHE = ISHFTC(1, 15)
  enumerator :: GTK_DEBUG_NO_PIXEL_CACHE = ISHFTC(1, 16)
  enumerator :: GTK_DEBUG_INTERACTIVE = ISHFTC(1, 17)
  enumerator :: GTK_DEBUG_TOUCHSCREEN = ISHFTC(1, 18)
  enumerator :: GTK_DEBUG_ACTIONS = ISHFTC(1, 19)
  enumerator :: GTK_DEBUG_RESIZE = ISHFTC(1, 20)
  enumerator :: GTK_DEBUG_LAYOUT = ISHFTC(1, 21)
end enum
...
enum, bind(c)    !GtkTextViewLayer
  enumerator :: GTK_TEXT_VIEW_LAYER_BELOW
  enumerator :: GTK_TEXT_VIEW_LAYER_ABOVE
...
enum, bind(c)    !GtkRegionFlags
  enumerator :: GTK_REGION_EVEN = ISHFTC(1, 0)
  enumerator :: GTK_REGION_ODD = ISHFTC(1, 1)
  enumerator :: GTK_REGION_FIRST = ISHFTC(1, 2)
  enumerator :: GTK_REGION_LAST = ISHFTC(1, 3)
  enumerator :: GTK_REGION_ONLY = ISHFTC(1, 4)
  enumerator :: GTK_REGION_SORTED = ISHFTC(1, 5)
end enum

enum, bind(c)    !GtkJunctionSides
  enumerator :: GTK_JUNCTION_NONE = 0
  enumerator :: GTK_JUNCTION_CORNER_TOPLEFT = ISHFTC(1, 0)
  enumerator :: GTK_JUNCTION_CORNER_TOPRIGHT = ISHFTC(1, 1)
  enumerator :: GTK_JUNCTION_CORNER_BOTTOMLEFT = ISHFTC(1, 2)
  enumerator :: GTK_JUNCTION_CORNER_BOTTOMRIGHT = ISHFTC(1, 3)
  enumerator :: GTK_JUNCTION_TOP = ior(GTK_JUNCTION_CORNER_TOPLEFT ,&
& GTK_JUNCTION_CORNER_TOPRIGHT)
  enumerator :: GTK_JUNCTION_BOTTOM = ior(GTK_JUNCTION_CORNER_BOTTOMLEFT ,&
& GTK_JUNCTION_CORNER_BOTTOMRIGHT)
  enumerator :: GTK_JUNCTION_LEFT = ior(GTK_JUNCTION_CORNER_TOPLEFT ,&
& GTK_JUNCTION_CORNER_BOTTOMLEFT)
  enumerator :: GTK_JUNCTION_RIGHT = ior(GTK_JUNCTION_CORNER_TOPRIGHT ,&
& GTK_JUNCTION_CORNER_BOTTOMRIGHT)
end enum
...
enum, bind(c)    !GtkPopoverConstraint
  enumerator :: GTK_POPOVER_CONSTRAINT_NONE
  enumerator :: GTK_POPOVER_CONSTRAINT_WINDOW
end enum
...
! gtkmodelbutton.h
enum, bind(c)    !GtkButtonRole
  enumerator :: GTK_BUTTON_ROLE_NORMAL
  enumerator :: GTK_BUTTON_ROLE_CHECK
  enumerator :: GTK_BUTTON_ROLE_RADIO
end enum
...
enum, bind(c)    !GtkButtonBoxStyle
  ...
  enumerator :: GTK_BUTTONBOX_EXPAND
end enum
...
enum, bind(c)    !GtkCssSectionType
  ...
  enumerator :: GTK_CSS_SECTION_KEYFRAMES
end enum
