...
enum, bind(c)    !GdkToplevelState
  enumerator :: GDK_TOPLEVEL_STATE_WITHDRAWN = ISHFTC(1, 0)
  enumerator :: GDK_TOPLEVEL_STATE_MINIMIZED = ISHFTC(1, 1)
  enumerator :: GDK_TOPLEVEL_STATE_MAXIMIZED = ISHFTC(1, 2)
  enumerator :: GDK_TOPLEVEL_STATE_STICKY = ISHFTC(1, 3)
  enumerator :: GDK_TOPLEVEL_STATE_FULLSCREEN = ISHFTC(1, 4)
  enumerator :: GDK_TOPLEVEL_STATE_ABOVE = ISHFTC(1, 5)
  enumerator :: GDK_TOPLEVEL_STATE_BELOW = ISHFTC(1, 6)
  enumerator :: GDK_TOPLEVEL_STATE_FOCUSED = ISHFTC(1, 7)
  enumerator :: GDK_TOPLEVEL_STATE_TILED = ISHFTC(1, 8)
  enumerator :: GDK_TOPLEVEL_STATE_TOP_TILED = ISHFTC(1, 9)
  enumerator :: GDK_TOPLEVEL_STATE_TOP_RESIZABLE = ISHFTC(1, 10)
  enumerator :: GDK_TOPLEVEL_STATE_RIGHT_TILED = ISHFTC(1, 11)
  enumerator :: GDK_TOPLEVEL_STATE_RIGHT_RESIZABLE = ISHFTC(1, 12)
  enumerator :: GDK_TOPLEVEL_STATE_BOTTOM_TILED = ISHFTC(1, 13)
  enumerator :: GDK_TOPLEVEL_STATE_BOTTOM_RESIZABLE = ISHFTC(1, 14)
  enumerator :: GDK_TOPLEVEL_STATE_LEFT_TILED = ISHFTC(1, 15)
  enumerator :: GDK_TOPLEVEL_STATE_LEFT_RESIZABLE = ISHFTC(1, 16)
end enum
