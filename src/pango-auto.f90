...
subroutine pango_tailor_break(text, length, analysis, offset, log_attrs,&
& log_attrs_len) bind(c)
  use, intrinsic :: iso_c_binding, only: c_char, c_int, c_ptr
  character(kind=c_char), dimension(*) :: text
  integer(c_int), value :: length
  type(c_ptr), value :: analysis
...
& accel_char, error) bind(c)
  use, intrinsic :: iso_c_binding, only: c_int, c_char, c_int32_t, c_ptr
...
function pango_get_mirror_char(ch, mirrored_ch) bind(c)
  use, intrinsic :: iso_c_binding, only: c_int, c_int32_t, c_char
...
function pango_renderer_get_alpha(renderer, part) bind(c)
  use, intrinsic :: iso_c_binding, only: c_int16_t, c_ptr, c_int
...
& accel_marker, accel_char) bind(c)
  use, intrinsic :: iso_c_binding, only: c_ptr, c_char, c_int, c_int32_t
  type(c_ptr), value :: layout
  character(kind=c_char), dimension(*) :: markup
  integer(c_int), value :: length
  integer(c_int32_t), value :: accel_marker
...
& property_bit) bind(c)
  use, intrinsic :: iso_c_binding, only: c_int, c_ptr, c_int32_t, c_long
