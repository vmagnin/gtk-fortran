...
function pango_markup_parser_finish(context, attr_list, text, accel_char, error&
&) bind(c) 
  use iso_c_binding, only: c_int, c_ptr, c_char
...
subroutine pango_shape_full(item_text, item_length, paragraph_text, paragraph_l&
&ength, analysis, glyphs) bind(c) 
  use iso_c_binding, only: c_char, c_int, c_ptr
...
function pango_x_list_subfonts(font, charsets, n_charsets, subfont_ids, subfont&
&_charsets) bind(c) 
  use iso_c_binding, only: c_int, c_ptr
