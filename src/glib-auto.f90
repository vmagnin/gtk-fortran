...
subroutine g_dbus_object_skeleton_remove_interface_by_name(object, interface_na&
&me) bind(c) 
  use iso_c_binding, only: c_ptr, c_char
  type(c_ptr), value :: object
  character(kind=c_char), dimension(*) :: interface_name
...
subroutine g_dbus_connection_call_with_unix_fd_list(connection, bus_name, objec&
&t_path, interface_name, method_name, parameters, reply_type, flags, timeout_ms&
&ec, fd_list, cancellable, callback, user_data) bind(c) 
  use iso_c_binding, only: c_ptr, c_char, c_int, c_funptr
  type(c_ptr), value :: connection
  character(kind=c_char), dimension(*) :: bus_name
  character(kind=c_char), dimension(*) :: object_path
...
function g_dbus_connection_call_with_unix_fd_list_finish(connection, out_fd_lis&
&t, res, error) bind(c) 
  use iso_c_binding, only: c_ptr
...
function g_dbus_connection_call_with_unix_fd_list_sync(connection, bus_name, ob&
&ject_path, interface_name, method_name, parameters, reply_type, flags, timeout&
&_msec, fd_list, out_fd_list, cancellable, error) bind(c) 
  use iso_c_binding, only: c_ptr, c_char, c_int
...
subroutine g_dbus_object_manager_server_set_connection(manager, connection) bin&
&d(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: manager
  type(c_ptr), value :: connection
...
subroutine g_dbus_object_manager_server_export_uniquely(manager, object) bind(c&
&) 
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: manager
  type(c_ptr), value :: object
...
&) 
  ...
  type(c_ptr), value :: stream
  character(kind=c_char), value :: data
  type(c_ptr), value :: cancellable
  type(c_ptr), value :: error
end function
...
subroutine g_tls_password_set_value_full(password, value, length, destroy) bind&
&(c) 
...
function g_tls_database_verify_chain(self, chain, purpose, identity, interactio&
&n, flags, cancellable, error) bind(c) 
  use iso_c_binding, only: c_int, c_ptr, c_char
...
subroutine g_tls_database_verify_chain_async(self, chain, purpose, identity, in&
&teraction, flags, cancellable, callback, user_data) bind(c) 
  use iso_c_binding, only: c_ptr, c_char, c_int, c_funptr
  type(c_ptr), value :: self
  type(c_ptr), value :: chain
  character(kind=c_char), dimension(*) :: purpose
...
function g_tls_database_lookup_certificate_for_handle(self, handle, interaction&
...
subroutine g_tls_database_lookup_certificate_for_handle_async(self, handle, int&
&eraction, flags, cancellable, callback, user_data) bind(c) 
  use iso_c_binding, only: c_ptr, c_char, c_int, c_funptr
  type(c_ptr), value :: self
  character(kind=c_char), dimension(*) :: handle
  type(c_ptr), value :: interaction
...
function g_tls_database_lookup_certificate_for_handle_finish(self, result, erro&
&r) bind(c) 
  use iso_c_binding, only: c_ptr
...
function g_tls_database_lookup_certificate_issuer(self, certificate, interactio&
&n, flags, cancellable, error) bind(c) 
  use iso_c_binding, only: c_ptr, c_int
...
subroutine g_tls_database_lookup_certificate_issuer_async(self, certificate, in&
&teraction, flags, cancellable, callback, user_data) bind(c) 
  use iso_c_binding, only: c_ptr, c_int, c_funptr
  type(c_ptr), value :: self
  type(c_ptr), value :: certificate
...
function g_tls_database_lookup_certificate_issuer_finish(self, result, error) b&
&ind(c) 
  use iso_c_binding, only: c_ptr
...
function g_tls_database_lookup_certificates_issued_by(self, issuer_raw_dn, inte&
&raction, flags, cancellable, error) bind(c) 
  use iso_c_binding, only: c_ptr, c_int
...
subroutine g_tls_database_lookup_certificates_issued_by_async(self, issuer_raw_&
&dn, interaction, flags, cancellable, callback, user_data) bind(c) 
  use iso_c_binding, only: c_ptr, c_int, c_funptr
  type(c_ptr), value :: self
  type(c_ptr), value :: issuer_raw_dn
  type(c_ptr), value :: interaction
...
function g_tls_database_lookup_certificates_issued_by_finish(self, result, erro&
&r) bind(c) 
  use iso_c_binding, only: c_ptr
...
subroutine g_dbus_object_manager_client_new(connection, flags, name, object_pat&
&h, get_proxy_type_func, get_proxy_type_user_data, get_proxy_type_destroy_notif&
&y, cancellable, callback, user_data) bind(c) 
  use iso_c_binding, only: c_ptr, c_int, c_char, c_funptr
  type(c_ptr), value :: connection
  integer(c_int), value :: flags
...
function g_dbus_object_manager_client_new_sync(connection, flags, name, object_&
&path, get_proxy_type_func, get_proxy_type_user_data, get_proxy_type_destroy_no&
&tify, cancellable, error) bind(c) 
  use iso_c_binding, only: c_ptr, c_int, c_char, c_funptr
...
subroutine g_dbus_object_manager_client_new_for_bus(bus_type, flags, name, obje&
&ct_path, get_proxy_type_func, get_proxy_type_user_data, get_proxy_type_destroy&
&_notify, cancellable, callback, user_data) bind(c) 
...
function g_dbus_object_manager_client_new_for_bus_sync(bus_type, flags, name, o&
&bject_path, get_proxy_type_func, get_proxy_type_user_data, get_proxy_type_dest&
&roy_notify, cancellable, error) bind(c) 
  use iso_c_binding, only: c_ptr, c_int, c_char, c_funptr
...
function g_dbus_object_manager_get_interface(manager, object_path, interface_na&
&me) bind(c) 
  use iso_c_binding, only: c_ptr, c_char
...
function g_tls_password_flags_get_type() bind(c) 
  use iso_c_binding, only: c_size_t
  integer(c_size_t) :: g_tls_password_flags_get_type
end function

!  GType g_tls_interaction_result_get_type (void) G_GNUC_CONST;
function g_tls_interaction_result_get_type() bind(c) 
  use iso_c_binding, only: c_size_t
  integer(c_size_t) :: g_tls_interaction_result_get_type
end function

!  GType g_dbus_interface_skeleton_flags_get_type (void) G_GNUC_CONST;
function g_dbus_interface_skeleton_flags_get_type() bind(c) 
  use iso_c_binding, only: c_size_t
  integer(c_size_t) :: g_dbus_interface_skeleton_flags_get_type
end function

!  GType g_dbus_object_manager_client_flags_get_type (void) G_GNUC_CONST;
function g_dbus_object_manager_client_flags_get_type() bind(c) 
  use iso_c_binding, only: c_size_t
  integer(c_size_t) :: g_dbus_object_manager_client_flags_get_type
end function

!  GType g_tls_database_verify_flags_get_type (void) G_GNUC_CONST;
function g_tls_database_verify_flags_get_type() bind(c) 
  use iso_c_binding, only: c_size_t
  integer(c_size_t) :: g_tls_database_verify_flags_get_type
end function

!  GType g_tls_database_lookup_flags_get_type (void) G_GNUC_CONST;
function g_tls_database_lookup_flags_get_type() bind(c) 
  use iso_c_binding, only: c_size_t
  integer(c_size_t) :: g_tls_database_lookup_flags_get_type
end function

!  GType g_io_module_scope_flags_get_type (void) G_GNUC_CONST;
function g_io_module_scope_flags_get_type() bind(c) 
  use iso_c_binding, only: c_size_t
  integer(c_size_t) :: g_io_module_scope_flags_get_type
end function
...
function g_data_input_stream_read_byte(stream, cancellable, error) bind(c) 
  use iso_c_binding, only: c_char, c_ptr
  character(kind=c_char) :: g_data_input_stream_read_byte
  type(c_ptr), value :: stream
  type(c_ptr), value :: cancellable
  type(c_ptr), value :: error
end function
...
function g_data_input_stream_read_line_finish_utf8(stream, result, length, erro&
&r) bind(c) 
  use iso_c_binding, only: c_ptr
...
subroutine g_key_file_set_list_separator(key_file, separator) bind(c) 
  use iso_c_binding, only: c_ptr, c_char
  type(c_ptr), value :: key_file
  character(kind=c_char), value :: separator
end subroutine
...
function g_compute_hmac_for_data(digest_type, key, key_len, data, length) bind(&
&c) 
  use iso_c_binding, only: c_ptr, c_int, c_char, c_size_t
...
function g_compute_hmac_for_string(digest_type, key, key_len, str, length) bind&
&(c) 
  use iso_c_binding, only: c_ptr, c_int, c_char, c_size_t
...
function g_ascii_toupper(c) bind(c) 
  use iso_c_binding, only: c_char
  character(kind=c_char) :: g_ascii_toupper
  character(kind=c_char), value :: c
end function
...
function g_strdelimit(string, delimiters, new_delimiter) bind(c) 
  ...
  character(kind=c_char), value :: new_delimiter
end function
...
function g_strcanon(string, valid_chars, substitutor) bind(c) 
  ...
  character(kind=c_char), value :: substitutor
end function
...
function g_strnfill(length, fill_char) bind(c) 
  ...
  integer(c_size_t), value :: length
  character(kind=c_char), value :: fill_char
end function
...
! const gchar * g_dcgettext (const gchar *domain, const gchar *msgid, int category) G_GNUC_FORMAT(2);
...
function g_unichar_fully_decompose(ch, compat, result, result_len) bind(c) 
  use iso_c_binding, only: c_size_t, c_int32_t, c_int, c_char
...
function g_variant_get_byte(value) bind(c) 
  use iso_c_binding, only: c_char, c_ptr
  character(kind=c_char) :: g_variant_get_byte
  type(c_ptr), value :: value
end function
...
subroutine g_value_set_char(value, v_char) bind(c) 
  use iso_c_binding, only: c_ptr, c_char
  type(c_ptr), value :: value
  character(kind=c_char), value :: v_char
end subroutine

! gchar g_value_get_char (const GValue *value);
function g_value_get_char(value) bind(c) 
  use iso_c_binding, only: c_char, c_ptr
  character(kind=c_char) :: g_value_get_char
  type(c_ptr), value :: value
end function
...
subroutine g_value_set_uchar(value, v_uchar) bind(c) 
  use iso_c_binding, only: c_ptr, c_char
  type(c_ptr), value :: value
  character(kind=c_char), value :: v_uchar
end subroutine

! guchar g_value_get_uchar (const GValue *value);
function g_value_get_uchar(value) bind(c) 
  use iso_c_binding, only: c_char, c_ptr
  character(kind=c_char) :: g_value_get_uchar
  type(c_ptr), value :: value
end function
...
subroutine g_cclosure_marshal_generic(closure, return_gvalue, n_param_values, p&
