...
! Last modification: 1-7-2012

! --------------------------------------------------------
! gtk-hl-assistant.f90
! Generated: Wed Mar 20 16:44:31 2013 GMT
! Please do not edit this file directly,
! Edit gtk-hl-assistant-tmpl.f90, and use ./mk_gtk_hl.pl to regenerate.
! Generated for GTK+ version: 3.6.0.
! Generated for GLIB version: 2.34.0.
! --------------------------------------------------------
...
module gtk_hl_assistant
  ...
  !********************************
  ! Gtk modules for gtk-hl-assistant-tmpl.f90
...
contains
  ...
  function hl_gtk_assistant_new(title, destroy, delete_event, data_destroy, &
    ...
    if (present(border)) call gtk_container_set_border_width(asstnt, border)
    if (present(wsize)) &
