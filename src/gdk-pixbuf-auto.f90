...
!     _GDK_PIXBUF_EXTERN void gdk_pixbuf_xlib_init (Display *display, int screen_num);
...
! _GDK_PIXBUF_EXTERN void gdk_pixbuf_xlib_init_with_depth (Display *display, int screen_num, int prefDepth);
...
!    _GDK_PIXBUF_EXTERN void gdk_pixbuf_xlib_render_threshold_alpha (GdkPixbuf *pixbuf, Pixmap bitmap, int src_x, int src_y, int dest_x, int dest_y, int width, int height, int alpha_threshold);
...
! _GDK_PIXBUF_EXTERN void gdk_pixbuf_xlib_render_to_drawable (GdkPixbuf *pixbuf, Drawable drawable, GC gc, int src_x, int src_y, int dest_x, int dest_y, int width, int height, XlibRgbDither dither, int x_dither, int y_dither);
...
! _GDK_PIXBUF_EXTERN void gdk_pixbuf_xlib_render_to_drawable_alpha (GdkPixbuf *pixbuf, Drawable drawable, int src_x, int src_y, int dest_x, int dest_y, int width, int height, GdkPixbufAlphaMode alpha_mode, int alpha_threshold, XlibRgbDither dither, int x_dither, int y_dither);
...
! _GDK_PIXBUF_EXTERN void gdk_pixbuf_xlib_render_pixmap_and_mask (GdkPixbuf *pixbuf, Pixmap *pixmap_return, Pixmap *mask_return, int alpha_threshold);
...
!    _GDK_PIXBUF_EXTERN GdkPixbuf *gdk_pixbuf_xlib_get_from_drawable (GdkPixbuf *dest, Drawable src, Colormap cmap, Visual *visual, int src_x, int src_y, int dest_x, int dest_y, int width, int height);
...
!  _GDK_PIXBUF_EXTERN void xlib_rgb_init (Display *display, Screen *screen);
...
!_GDK_PIXBUF_EXTERN void xlib_rgb_init_with_depth (Display *display, Screen *screen, int prefDepth);
...
! _GDK_PIXBUF_EXTERN unsigned long xlib_rgb_xpixel_from_rgb (guint32 rgb);
...
! _GDK_PIXBUF_EXTERN void xlib_rgb_gc_set_foreground (GC gc, guint32 rgb);
...
! _GDK_PIXBUF_EXTERN void xlib_rgb_gc_set_background (GC gc, guint32 rgb);
...
! _GDK_PIXBUF_EXTERN void xlib_draw_rgb_image (Drawable drawable, GC gc, int x, int y, int width, int height, XlibRgbDither dith, unsigned char *rgb_buf, int rowstride);
...
! _GDK_PIXBUF_EXTERN void xlib_draw_rgb_image_dithalign (Drawable drawable, GC gc, int x, int y, int width, int height, XlibRgbDither dith, unsigned char *rgb_buf, int rowstride, int xdith, int ydith);
...
! _GDK_PIXBUF_EXTERN void xlib_draw_rgb_32_image (Drawable drawable, GC gc, int x, int y, int width, int height, XlibRgbDither dith, unsigned char *buf, int rowstride);
...
! _GDK_PIXBUF_EXTERN void xlib_draw_gray_image (Drawable drawable, GC gc, int x, int y, int width, int height, XlibRgbDither dith, unsigned char *buf, int rowstride);
...
! _GDK_PIXBUF_EXTERN XlibRgbCmap * xlib_rgb_cmap_new (guint32 *colors, int n_colors);
...
! _GDK_PIXBUF_EXTERN void xlib_rgb_cmap_free (XlibRgbCmap *cmap);
subroutine xlib_rgb_cmap_free(cmap) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: cmap
end subroutine

! _GDK_PIXBUF_EXTERN void xlib_draw_indexed_image (Drawable drawable, GC gc, int x, int y, int width, int height, XlibRgbDither dith, unsigned char *buf, int rowstride, XlibRgbCmap *cmap);
...
function gdk_pixbuf_animation_new_from_stream(stream, cancellable, error) bind(&
&c)
  use iso_c_binding, only: c_ptr
...
subroutine gdk_pixbuf_animation_new_from_stream_async(stream, cancellable, call&
...
function gdk_pixbuf_animation_new_from_stream_finish(async_result, error) bind(&
&c)
  use iso_c_binding, only: c_ptr
...
subroutine gdk_pixbuf_get_file_info_async(filename, cancellable, callback, user&
&_data) bind(c)
...
function gdk_pixbuf_get_file_info_finish(async_result, width, height, error) bi&
&nd(c)
  use iso_c_binding, only: c_ptr
...
function gdk_pixbuf_new_from_bytes(data, colorspace, has_alpha, bits_per_sample&
&, width, height, rowstride) bind(c)
  use iso_c_binding, only: c_ptr, c_int
...
function gdk_pixbuf_save_to_streamv(pixbuf, stream, type, option_keys, option_v&
&alues, cancellable, error) bind(c)
  use iso_c_binding, only: c_int, c_ptr, c_char
