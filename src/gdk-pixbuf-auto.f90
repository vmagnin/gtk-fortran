...
subroutine xlib_draw_rgb_image(drawable, gc, x, y, width, height, dith,&
& rgb_buf, rowstride) bind(c)
...
subroutine gdk_pixbuf_xlib_init_with_depth(display, screen_num, prefDepth)&
& bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: display
  integer(c_int), value :: screen_num
...
subroutine gdk_pixbuf_xlib_render_to_drawable(pixbuf, drawable, gc, src_x,&
& src_y, dest_x, dest_y, width, height, dither, x_dither, y_dither) bind(c)
  use iso_c_binding, only: c_ptr, c_long, c_int
  type(c_ptr), value :: pixbuf
  integer(c_long), value :: drawable
  type(c_ptr), value :: gc
...
& src_y, dest_x, dest_y, width, height, alpha_mode, alpha_threshold, dither,&
& x_dither, y_dither) bind(c)
  use iso_c_binding, only: c_ptr, c_long, c_int
  type(c_ptr), value :: pixbuf
  integer(c_long), value :: drawable
  integer(c_int), value :: src_x
...
subroutine gdk_pixbuf_xlib_render_pixmap_and_mask(pixbuf, pixmap_return,&
...
function gdk_pixbuf_xlib_get_from_drawable(dest, src, cmap, visual, src_x,&
& src_y, dest_x, dest_y, width, height) bind(c)
  use iso_c_binding, only: c_ptr, c_long, c_int
