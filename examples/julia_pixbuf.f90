...
program julia
  ...
  call gtk_table_attach_defaults(table, button2, 1_c_int, 2_c_int, 3_c_int, 4_c_int)
  call gtk_table_attach_defaults(table, button3, 3_c_int, 4_c_int, 3_c_int, 4_c_int)
  call gtk_table_attach_defaults(table, label1, 0_c_int, 1_c_int, 0_c_int, 1_c_int)
  call gtk_table_attach_defaults(table, label2, 0_c_int, 1_c_int, 1_c_int, 2_c_int)
  call gtk_table_attach_defaults(table, label3, 0_c_int, 1_c_int, 2_c_int, 3_c_int)
  call gtk_table_attach_defaults(table, spinButton1, 1_c_int, 2_c_int, 0_c_int, 1_c_int)
  call gtk_table_attach_defaults(table, spinButton2, 1_c_int, 2_c_int, 1_c_int, 2_c_int)
  call gtk_table_attach_defaults(table, spinButton3, 1_c_int, 2_c_int, 2_c_int, 3_c_int)  
  call gtk_table_attach_defaults(table, linkButton, 3_c_int, 4_c_int, 0_c_int, 1_c_int)
  call gtk_table_attach_defaults(table, label4, 2_c_int, 3_c_int, 0_c_int, 1_c_int)
  call gtk_table_attach_defaults(table, combo1, 2_c_int, 3_c_int, 1_c_int, 2_c_int)
  call gtk_table_attach_defaults(table, toggle1, 2_c_int, 3_c_int, 3_c_int, 4_c_int)
  ...
  box1 = gtk_vbox_new (FALSE, 10_c_int);
  ...
  call gtk_text_buffer_set_text (buffer, "Julia Set"//C_NEW_LINE// &
      & "You can copy this text and even edit it !"//C_NEW_LINE//c_null_char, -1_c_int)
