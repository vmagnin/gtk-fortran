...
program gtkFortran
  ...
  table = gtk_table_new (15_c_int, 4_c_int, TRUE)
  call gtk_container_add (window, table)

  button1 = gtk_button_new_with_label ("Button1"//c_null_char)
  call gtk_table_attach_defaults(table, button1, 0_c_int, 1_c_int, &
       & 0_c_int, 1_c_int)
  ...
  call gtk_table_attach_defaults(table, button2, 1_c_int, 2_c_int, &
       & 0_c_int, 1_c_int)
  ...
  call gtk_table_attach_defaults(table, button3, 2_c_int, 3_c_int, &
       & 0_c_int, 1_c_int)
  call g_signal_connect (button3, "clicked"//c_null_char, c_funloc(destroy))

  button4 = gtk_button_new_with_label ("About"//c_null_char)
  call gtk_table_attach_defaults(table, button4, 3_c_int, 4_c_int, &
       & 0_c_int, 1_c_int)
  ...
  call gtk_table_attach_defaults(table, progress, 0_c_int, 3_c_int, &
       & 2_c_int, 3_c_int)  
  ...
  call gtk_table_attach_defaults(table, scrolled_window, 0_c_int, 3_c_int, &
       & 3_c_int, 6_c_int)  

  my_drawing_area = gtk_drawing_area_new()
  call g_signal_connect (my_drawing_area, "expose-event"//c_null_char, c_funloc(expose_event))
  call gtk_table_attach_defaults(table, my_drawing_area, 0_c_int, 3_c_int, 6_c_int, 11_c_int)  
  
  file_selector = gtk_file_chooser_button_new ("gtk_file_chooser_button_new"//c_null_char, 0_c_int)
  call gtk_table_attach_defaults(table, file_selector, 0_c_int, 3_c_int, &
       & 12_c_int, 13_c_int)  
  call g_signal_connect (file_selector, "selection-changed"//c_null_char, &
       & c_funloc(file_changed));
